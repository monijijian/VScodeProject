...
console.log(Stuent.constructor);//输出[Function:Function]
console.log(Stuent.prototype);//指向原型，之前原型添加的方法也出来了

//判断实例对象是否对应了原型对象
console.log(Stuent.isPrototypeOf(s2));
console.log(Stuent.prototype.isPrototypeOf(s2));

console.log(s2.hasOwnProperty('name'));//判断方法或者属性是否在实例中
delete s2.name;//删除实例属性
console.log('then:  ' + s2.hasOwnProperty('sing'));
delete s2.sayName;
console.log('sayName' in s2);// in操作符，原型和实例中只要有就返回true
